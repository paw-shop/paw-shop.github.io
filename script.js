...
const translations = {
  es: {
    ...
    "hero.description": "Alphy es un portfolio y tienda virtual de arte 3D enfocado en modelado y texturizado de assets digitales, con calidad visual, estilo y optimizacion.",
  ...
  en: {
    ...
    "hero.description": "Alphy is a 3D art portfolio and virtual store focused on modeling and texturing digital assets, with visual quality, style, and optimization.",
